...
# ---------------------------------- AYUDA ----------------------------------
ayuda="
Ayuda correspondiente al script ejercicio4.sh
...
# Funcion que recorre los archivos .CSV
recorrerCSV() {
...
# Funcion que borra archivos temporales
borrarTemporales() {
	rm tempConsolidado
	rm tempAgrupado
}
...
# Funcion que procesa las sucursales y crea salida.json
procesarSucursales() {
